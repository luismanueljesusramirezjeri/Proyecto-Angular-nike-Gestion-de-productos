...
@Component({
  ...
  styleUrl: './inicio-gestion.component.css'
})
export class InicioGestionComponent {
  ...
  filters = { name: '', category: '' , includeNoImage: false }; // Filtros para productos
  ...
  filterProducts(): void {
    this.filteredProducts = this.products.filter(product => {
      ...
      const matchesImage = this.filters.includeNoImage ? !product.imageUrl : true;
